...
# -----------------------------------------------------------------
        ...
        # Time Complexity: O(n) /   Runtime: faster than 64.26%
        # Space Complexity: O(n) /   Memory Usage: less than 7.18%
...
# -----------------------------------------------------------------
        ...
        # Time Complexity: O(n) /   Runtime: faster than 6.72%
        # Space Complexity: O(1) /   Memory Usage: less than 76.16%
